...
class KuisScreen extends StatefulWidget {
  KuisScreen({Key? key}) : super(key: key);
    ...
    return SafeArea(
      ...
      body: Container(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Container(
                margin: EdgeInsets.only(left: 37.h, top: 20.v, right: 37.h),
                ...
                child: Column(
                    ...
                    children: [
                      Container(
                          width: 146.h,
                          margin: EdgeInsets.only(left: 6.h, right: 40.h),
                          child: Text("Yuk, Uji Ketangksanmu\nNdek Wulangan",
                              maxLines: 2,
            ...
            Text("Kuis Bahasa Jawa", style: theme.textTheme.titleMedium),
            Align(
