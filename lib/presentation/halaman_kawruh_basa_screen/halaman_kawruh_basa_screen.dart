...
class HalamanKawruhBasaScreen extends StatefulWidget {
  HalamanKawruhBasaScreen({Key? key}) : super(key: key);

  @override
  _HalamanKawruhBasaScreenState createState() =>
      _HalamanKawruhBasaScreenState();
}

class _HalamanKawruhBasaScreenState extends State<HalamanKawruhBasaScreen> {
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                ...
                                // dibedakan dengan id
                                Navigator.pushNamed(
                                    context, AppRoutes.halamanKawruhBasaSubMenu,
