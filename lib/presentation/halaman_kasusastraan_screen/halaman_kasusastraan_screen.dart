...
class _HalamanKasusastraanScreenState
    extends State<HalamanKasusastraanScreen> {
  var user;
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context, AppRoutes.halamanKasusastraanSubMenu, arguments: AppRoutes(id: 1, obj: {}));
                                    },
                                    child: Container(
                                      padding: EdgeInsets.symmetric(
                                        horizontal: 29.h,
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context, AppRoutes.halamanKasusastraanSubMenu, arguments: AppRoutes(id: 2, obj: {}));
                                    },
                                    child: Container(
                                      padding: EdgeInsets.symmetric(
                                        horizontal: 29.h,
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context, AppRoutes.halamanKasusastraanSubMenu, arguments: AppRoutes(id: 3, obj: {}));
                                    },
                                    child: Container(
                                      padding: EdgeInsets.symmetric(
                                        horizontal: 29.h,
